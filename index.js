...
CoveragePlugin.prototype.setup = function() {
    ...
    console.log('self.config.outdir', self.config.outdir);
    ...
    browser.executeScript(function() {
        var helper = {
            hashCode: function(s) {
                ...
                return clean.split("").reduce(function(a, b) {
...
CoveragePlugin.prototype.outputResults = function(done) {
    ...
    try {
        fs.mkdirSync(self.config.outdir);
    } catch (e) {
    ...
    // copy report folder
    wrench.copyDirRecursive(__dirname + '/reports', self.config.outdir, { forceDelete: false }, done);
};
